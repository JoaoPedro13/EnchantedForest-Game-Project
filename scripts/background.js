class Background {
  constructor(game) {
      ...
      this.wall = new Image();
      this.wall.src = './scripts/images/wall.png';
      this.wallRight = new Image();
      this.wallRight.src = './scripts/images/wall-right.png';
      this.wallLeft = new Image();
      this.wallLeft.src = './scripts/images/wall-left.png';
      this.wallBottom = new Image();
      this.wallBottom.src = './scripts/images/wall-bottom.png';
      this.floor = new Image();
      this.floor.src = './scripts/images/floor.png';
